...
| ✏️ **Update** | Edit any note's title, content, and user ID |
| 🗑️ **Delete** | Remove notes with a swipe-up confirmation sheet |
| 🔄 **Pull to refresh** | Swipe down to reload notes from the API |
| ⚠️ **Error handling** | Friendly error screen with retry action |
